...
import com.do1.seller.repositoriesbackup.VerifyRepository;
...
public class DataAccessConfiguration {
    ...
    // repository 扫描的时候，并不确定哪个先扫描，查看源代码   将不同的数据源放在不同的Repository下   不同数据源分包
    ...
    protected Map<String, Object> getVendorProperties(DataSource dataSource) {
        ...
        vendorProperties.putAll(properties.getHibernateProperties(new HibernateSettings().ddlAuto(defaultDdlMode).physicalNamingStrategy(physicalNamingStrategy.getIfAvailable()
