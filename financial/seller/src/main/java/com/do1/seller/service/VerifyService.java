...
import com.do1.entity.VerificationOrder;
...
public class VerifyService {
    ...
    @Value("${verification.rootdir:d:/opt/verification}")
     ...
     * @throws IOException 
     */
    public void saveChanOrders(String chanId,Date day) throws IOException{
        ...
        try {
            ...
            System.out.println("保存渠道订单数据"+content);
        } catch (IOException e) {
            e.printStackTrace();
        }
